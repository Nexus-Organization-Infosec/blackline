...
class ReconPipelineTests(unittest.TestCase):
    ...
    def test_build_recon_pipeline_is_deterministic_for_same_input(self):
        ...
        self.assertEqual([step.name for step in first.steps], ["http_probe", "httpx_probe", "web_fingerprint", "whatweb_fingerprint", "dns", "ipintel", "tls_inspection", "rdap", "port_scan"])
    ...
    def test_domain_pipeline_order(self):
        ...
        self.assertEqual(
            [step.name for step in pipeline.steps],
            ["dns", "ipintel", "http_probe", "httpx_probe", "web_fingerprint", "whatweb_fingerprint", "tls_inspection", "rdap", "rpcinfo", "port_scan"],
        )
    ...
    def test_surface_profile_excludes_network_intel_but_keeps_bounded_port_scan(self):
        ...
        self.assertEqual(
            [step.name for step in pipeline.steps],
            ["dns", "http_probe", "httpx_probe", "web_fingerprint", "whatweb_fingerprint", "tls_inspection", "rdap", "rpcinfo", "port_scan"],
        )
